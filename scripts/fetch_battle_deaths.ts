...
async function run(): Promise<void> {
  ...
  await upsertSource("ucdp_battle_deaths", {
    ...
    cadence: "annual",
    method:
      "Aggregate UCDP battle-related deaths by type_of_conflict using best_estimate/best; join World Bank SP.POP.TOTL population; compute per 100k; enforce 1990-latest continuous coverage.",
