...
async function run() {
  ...
  console.log(`GAISUM firearm_stock_per_100 → ${series.length} rows (${gaisum.min_year}-${gaisum.max_year}), range [${gaisum.min_value.toFixed(3)} – ${gaisum.max_value.toFixed(3)}]`);
  return series;
}
